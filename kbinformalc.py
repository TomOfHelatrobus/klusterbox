...
# standard libraries
from tkinter import messagebox, ttk, BOTH, BOTTOM, Canvas, END, Listbox, mainloop, NW, OptionMenu, Radiobutton, \
    RIDGE, RIGHT, Scrollbar, StringVar, TclError, Tk, VERTICAL, Y, Menu, filedialog, DISABLED, Button, Label, \
    LEFT, Entry, Frame
from kbreports import Archive, InformalCIndex
...
#                                command=lambda: InfcSpeedSheetGen(self.win.topframe, self.station, "selected").selected())
