...
a = Analysis(['klusterbox.py'],
		...
		('/Users/thomas/klusterbox/kbpdfhandling.py','.'),
		('/Users/thomas/klusterbox/kbinformalc.py','.'),
		('/Users/thomas/klusterbox/kbfixes.py','.'),
		('/Users/thomas/klusterbox/kbequitability.py','.'),
		('/Users/thomas/klusterbox/kbenterrings.py','.'),
		('/Users/thomas/klusterbox/kbdatabase.py','.'),					
		('/Users/thomas/klusterbox/kbcsv_repair.py','.'),
		('/Users/thomas/klusterbox/kbcsv_reader.py','.'),
		('/Users/thomas/klusterbox/kb_templategofer.py','.')],
             hiddenimports=[],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
