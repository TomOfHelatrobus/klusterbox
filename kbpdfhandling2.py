...
class PdfConverter:
    ...
    class StartUp:
        ...
        def run(self):
            ...
            self.parent.create_new_file()  # create and start the csv file that is created by the pdf converter.
        ...
        def split_document(self):
            """ split the document into pages. The character which indicates a new page often appears as an
            up arrow in the text. """
    ...
    class PageAnalysis:
        ...
        def run(self):
            ...
            self.start_analysis()  # go page by page for analysis.
            self.parent.pb.stop()
        ...
        def start_analysis(self):
            ...
            for page in self.parent.pages:
                if page:  # analyse the page if it contains something
                    self.analyse_page(page)  # send for page analysis
        ...
        def new_csv(self):
            ...
            self.parent.create_new_file()  # create the headers for the new file with self.create_new_file()
